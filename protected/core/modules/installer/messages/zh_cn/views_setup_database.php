...
return [
    ...
    'The name of the database you want to run Shop in.' => '你想要存shop数据的数据库名',
    'Your MySQL password.' => '数据库存密码。',
    'Your MySQL username' => '数据库用户名',
    'The prefix of the database\'s table. eg. sp_' => '数据库表的前缀，例如 sp_',
    'Set administrator account...' => '正在设置管理员帐号...',
];
