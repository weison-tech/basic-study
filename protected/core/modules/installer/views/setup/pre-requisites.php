...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <p><?php echo Yii::t('InstallerModule.views_setup_pre-requisites', 'This overview shows all system requirements of Yii2-Shop.'); ?></p>
        ...
        <?php if (!$hasError): ?>
            <?php echo Html::a(Yii::t('InstallerModule.views_setup_pre-requisites', 'Next') . ' <i class="fa fa-arrow-circle-right"></i>', array('/installer/setup/database'), array('class' => 'btn btn-primary', 'data-ui-loader' => '')); ?>
        <?php endif; ?>
